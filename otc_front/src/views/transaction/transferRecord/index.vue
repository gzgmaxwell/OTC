<template>
  <div class="list_page">
      ...
      <div class="search_box">
          ...
          <el-select filterable v-model='params.fromInvitationCode'  placeholder='请选择付款人码商' style="width: 30%; margin-left: 10px;" >
                    <el-option v-for='user in users' :key='user.memberId' :label='user.nickName+"-"+user.memberId' :value='user.memberId'></el-option>
          </el-select>

          <el-select filterable v-model='params.purposeInvitationCode'  placeholder='请选择收款人码商' style="width: 30%; margin-left: 10px;" >
                    <el-option v-for='user in users' :key='user.memberId' :label='user.nickName+"-"+user.memberId' :value='user.memberId'></el-option>
          </el-select>
