  ...
  data() {
    return {
      ...
      rules: {
        ...
        pictime: [
          { required: true, message: "请输入图片日期", trigger: "blur" },
          { max: 50, message: "长度最多为50", trigger: "blur" }
        ],
        type: [
        ...
        timechar: [
          { required: true, message: "请输入时间字符串", trigger: "blur" },
          { max: 50, message: "长度最多为50", trigger: "blur" }
        ],
        area: [
