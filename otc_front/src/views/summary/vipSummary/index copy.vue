<template>
  <div class="list_page">
    ...
    <div class="table_wrapper" style="height: calc(100% - 300px);">
      <el-table ref="multipleTable" :data="dataList || []" border height="100%" stripe style="width: 100%;">
...
<script>
import { TransferRecordPage, statistical_count, paymentOrdersList } from "@a/summary";
...
export default {
  ...
  methods: {
    ...
    async List() {
      this.params.descs = "a.update_time";
      this.params.merchantNo = "3856625";
      this.params.channelType = "a";
