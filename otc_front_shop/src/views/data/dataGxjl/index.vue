<template>
  <div class="list_page">
      ...
      <div class="search_box">
          ...
          <el-input placeholder="请输入文件名称" style="width: 30%;" v-model="params.name" @keyup.enter.native="search"></el-input>
...
import {DataGxjlPage , DataGxjlDelete} from "@a/data";
...
export default {
  ...
  methods: {
    ...
    //获取列表
    async List() {
        const   data  = await DataGxjlPage(this.params);
