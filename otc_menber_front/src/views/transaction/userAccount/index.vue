      ...
      <el-form :model="transferForm" label-position="left" label-width="80px">
        <el-form-item label="金额">
          <el-input
            ...
            type="text"
            @input="formatMoneyInput('transfer')"
            @blur="ensureTwoDecimals('transfer')"
          ></el-input>
        </el-form-item>
      </el-form>
      ...
      <el-form :model="withdrawForm" label-position="left" label-width="80px">
        <el-form-item label="金额">
          <el-input
            ...
            placeholder="请输入金额，如 0.01"
            type="text"
            @input="formatMoneyInput('withdraw')"
            @blur="ensureTwoDecimals('withdraw')"
          ></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
    ...
    validateMoney(moneyStr) {
      ...
      if (!reg.test(moneyStr)) {
        this.$message.warning(
          "请输入大于0的有效金额，最多保留两位小数（例如：0.01、10、123.45）"
        );
        return false;
      }
