  ...
  <div class="edit_page">
    ...
    <div class="edit_content">
      ...
      >
        ...
        <el-row :gutter="20" type="flex" class="row-bg" justify="left">
          <el-col :span="8" :offset="2">
            <el-form-item label="联系人" prop="lxr">
              <el-input
                v-model="formValidate.lxr"
                style="width: 100%;"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8" :offset="2">
            <el-form-item label="联系方式" prop="contactPersonMobile">
              <el-input
                v-model="formValidate.contactPersonMobile"
                style="width: 100%;"
              ></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="20" type="flex" class="row-bg" justify="left">
          <el-col :span="18" :offset="2">
            ...
            <el-form-item label="位置" >
                <el-cascader style="width: 100%;"   v-model="orgValue"    :options="orgs"  @change="handleChange"></el-cascader>
            </el-form-item> -->
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20" type="flex" class="row-bg" justify="left">
          <el-col :span="8" :offset="2">
            <el-form-item label="组织机构证明" prop="businessLicense">
              ...
              >
                <img
                  v-if="formValidate.businessLicense"
                  :src="formValidate.businessLicense"
                  class="avatar"
                />
...
<script>
import { userZfInfo, userZfSave, userZfUpdate, orgCascade } from "@a/system";
...
export default {
  ...
  methods: {
    ...
    //获取列表详情接口
    async getInfo(id) {
      const data = await userZfInfo(id);
    ...
    //新增保存接口
    async addData() {
      await userZfSave(this.formValidate);
    ...
    //编辑保存接口
    async editData() {
      await userZfUpdate(this.formValidate);
