        ...
        <el-row :gutter="20" type="flex" class="row-bg" justify="center">
          <el-col :span="10">
            <el-form-item label="专家头像">
              ...
              >
                <img
                  v-if="formValidate.headerUrl"
                  :src="formValidate.headerUrl"
                  class="avatar"
                />
...
export default {
  ...
  data() {
    return {
      ...
      data: [],
      rules: {
        lxs: [{ required: true, message: "请选择专家类型", trigger: "blur" }],
        userName: [
        ...
        headerUrl: [
          { required: true, message: "请输入专家头像", trigger: "blur" },
          { max: 250, message: "长度最多为250", trigger: "blur" }
        ],
        dw: [
        ...
        lxfs: [
          { required: true, message: "请输入生产模式", trigger: "blur" },
          { max: 50, message: "长度最多为50", trigger: "blur" }
        ],
        contact: [
        ...
        intro: [
          ...
          { max: 2000, message: "长度最多为2000", trigger: "blur" }
        ],
        sclyms: [
