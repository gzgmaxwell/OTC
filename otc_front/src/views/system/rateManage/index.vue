  ...
  <div class="list_page">
    <div class="top_wrapper">
      <div class="search_box">
        <el-input placeholder="费率名称" v-model="params.feeName" @keyup.enter.native="search" style="width: 30%;">
        </el-input>
        <el-select v-model="params.feeType" placeholder="费率类型" @keyup.enter.native="search()"
      ...
      <el-table ref="multipleTable" :data="list" border height="100%">
        ...
        <el-table-column prop="feeType" label="费率类型">
          <template slot-scope="scope">
            {{
              configTypeMap[String(scope.row.feeType)] ||
              scope.row.feeType
            }}
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    async List() {
      ...
      const data = await fee_page(this.params);
