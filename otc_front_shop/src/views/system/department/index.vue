<template>
  <div class="page">
    <el-card shadow="never" class="box-card">
      ...
      <el-card class="search-more" v-show="isShow">
        ...
        <div style="text-align:center;margin-top:30px">
          ...
          >
          <el-button class="ml-10" @click="reset()">重置</el-button>
          <el-button class="ml-10" @click="back()">返回</el-button>
        </div>
      </el-card>
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-button
                ...
                >编辑</el-button
              >
              <!-- <el-button size="medium" type="text" @click="view(scope.$index, scope.row)">查看</el-button> -->
              <el-button
                size="medium"
                type="text"
...
export default {
  ...
  data() {
    return {
      id: "",
      import_url: this.http_url + "/api/system/sysDepartment/import",
      params: {
        size: 10,
        current: 1,
        departmentName: null
  ...
  methods: {
    ...
    Export() {
      ...
      let downExcelUrl =
        this.http_url +
        `/api/system/sysDepartment/export?excel=${encodeURI(
    ...
    async delData(array) {
      let {
        ...
        data,
        msg
      } = await this.$ajax.sysDepartmentApi.sysDepartmentDelete(array);
      if (code == 200) {
