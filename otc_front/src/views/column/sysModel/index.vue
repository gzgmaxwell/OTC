<template>
  <div class="list_page">
    ...
    <div class="table_wrapper">
      ...
      >
        <el-table-column prop="modelName" label="栏目名称"></el-table-column>
...
<script>
import { SysModelPage, SysModelDelete } from "@a/column";
...
export default {
  ...
  methods: {
    ...
    async List() {
      ...
      const data = await SysModelPage(this.params);
