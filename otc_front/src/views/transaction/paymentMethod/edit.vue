  ...
  <div class="edit_page">
    <div class="top_box">
      ...
      <div>
        ...
        <el-button size="mini" type="danger" @click="rztg('3')"
          >不通过</el-button
        >
        ...
        >
          <el-col :span="10">
            <el-form-item label="支付宝账户" prop="zfbAccount">
              <el-input
                v-model="formValidate.zfbAccount"
                disabled
                style="width: 100%;"
              ></el-input>
            </el-form-item>
          ...
          <el-col :span="10">
            <el-form-item label="支付宝二维码" prop="zfbEwm">
              <img
                :src="formValidate.zfbEwm"
                v-if="formValidate.zfbEwm"
        ...
        >
          <el-col :span="10">
            <el-form-item label="微信账号" prop="wxAccount">
              <el-input
                v-model="formValidate.wxAccount"
                disabled
                style="width: 100%;"
              ></el-input>
            </el-form-item>
          ...
          <el-col :span="10">
            <el-form-item label="微信二维码" prop="wxEwm">
              <img
                :src="formValidate.wxEwm"
                v-if="formValidate.wxEwm"
                style="width: 100px; height: 80px"
              />
            </el-form-item>
          </el-col>
        ...
        >
          ...
          <el-col :span="10">
            <el-form-item label="银行卡号" prop="bankCardNumber">
              <el-input
                v-model="formValidate.bankCardNumber"
                disabled
                style="width: 100%;"
              ></el-input>
            </el-form-item>
