  ...
  <div class="list_page">
	...
	<div class="table_wrapper">
      <el-table ref="multipleTable" :data="list" border height="100%">
						  ...
						  <el-table-column prop="ground" label="区域"></el-table-column>
...
import {ZtAreaPage , ZtAreaDelete} from "@a/zt";
  ...
  methods: {
    ...
    async List() {
	  this.params.descs = "a.update_time";
        const   data  = await ZtAreaPage(this.params);
