...
// online demos at https://janus.conf.meetecho.com) you can just use a
...
if (window.location.protocol === "http:")
  //server = "https://" + window.location.hostname + ":9020/janus";
  // yujianbo
  server = "https://" + "10.80.21.211" + ":9022/janus";
//server = "https://" + window.location.hostname + ":9022/janus";
// -yujianbo
else server = "https://" + "10.80.21.211" + ":9022/janus";
        ...
        success: function() {
          ...
          janus.attach({
            ...
            onlocalstream: function(stream) {
              ...
              if (
                tts.webrtcStuff.pc.iceConnectionState !== "completed" &&
            ...
            onremotestream: function(stream) {
              ...
              // }
              Janus.attachMediaStream(
                document.getElementById("peeraudio"),
                stream
              );
              var audioTracks = stream.getAudioTracks();
              if (
