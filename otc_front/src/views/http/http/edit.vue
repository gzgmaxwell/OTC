      ...
      >
        ...
        <el-form-item label="请求头：">
          <div>
            ...
            <el-table ref="multipleTable" :data="formValidate.headers" border>
              ...
              <el-table-column label="操作" width="260">
                <template slot-scope="scope">
                  <el-button
                    ...
                    size="mini"
                    @click="saveHeader(scope.$index)"
                    >保存</el-button
                  >
                  <el-button
                    size="mini"
                    type="primary"
                    @click="editHeader(scope.$index)"
                    >编辑</el-button
                  >
                  <el-button
                    size="mini"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        text: [{ required: true, message: "请输入请求内容", trigger: "blur" }],
        startTime: [
